...
#import "CCGLWindowController.h"
#import "CCGLFullscreenWindow.h"

@interface CCGLWindowController ()
{
    // Fullscreen window
    CCGLFullscreenWindow *_fullscreenWindow;
...
@implementation CCGLWindowController
...
- (void) goFullscreen
{
	...
	_fullscreenWindow = [[CCGLFullscreenWindow alloc] init];
